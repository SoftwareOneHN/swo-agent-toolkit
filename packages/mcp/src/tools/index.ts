  ...
  switch (setup.kind) {
    case "no-agents-md":
      return [
        ...
        "This MCP needs to be launched from inside a project initialized with swo-agent-toolkit.",
        "",
        "To set up:",
        "  1. cd into your project root",
        "  2. Run `npx @swohn/cli@latest init`  (creates .skillsrc)",
        "  3. Run `npx @swohn/cli@latest sync`  (installs skills)",
    ...
    case "no-skills-dir":
      return [
        ...
        "",
        "To install skills:",
        "  Run `npx @swohn/cli@latest sync` from the project root.",
        "",
  ...
  if (ctx.setup.kind !== "ready" || ctx.index.isEmpty()) {
    ...
    return {
      content: [
        {
          type: "text",
          text: "No skills are loaded in this project. Run `npx @swohn/cli@latest sync` to install standard skills, then restart the MCP server.",
        },
      ],
    };
  }
      ...
      content: [
        {
          ...
          text: [
            ...
            "Restart the MCP server, or run `npx @swohn/cli@latest sync` to reinstall skills.",
          ].join("\n"),
        },
      ],
    };

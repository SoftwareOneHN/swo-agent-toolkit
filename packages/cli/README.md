...
[![NPM Version](https://img.shields.io/npm/v/swo-agent-toolkit.svg?style=flat-square)](https://www.npmjs.com/package/swo-agent-toolkit)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg?style=flat-square)](https://github.com/SoftwareOneHN/swo-agent-toolkit/blob/main/LICENSE)
...
```bash
npx swo-agent-toolkit@latest init   # detect your stack
npx swo-agent-toolkit@latest sync   # install skills
```
...
```yaml
registry: https://github.com/SoftwareOneHN/swo-agent-toolkit
...
The CLI **distributes** skills as static files. The companion [`swo-agent-mcp`](https://www.npmjs.com/package/swo-agent-mcp) server **serves** them at runtime as MCP tool calls — closing the gap where sub-agents skip skill loading because they don't inherit `AGENTS.md`.
...
- **Transparent** — fetches from the [public registry](https://github.com/SoftwareOneHN/swo-agent-toolkit), nothing hidden
...
- [Registry & Skills](https://github.com/SoftwareOneHN/swo-agent-toolkit)
- [Architecture](./ARCHITECTURE.md)
- [Report an Issue](https://github.com/SoftwareOneHN/swo-agent-toolkit/issues)

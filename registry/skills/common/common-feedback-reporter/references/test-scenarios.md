...
```bash
# AI should execute:
npx swo-agent-toolkit feedback \
  --skill="react/hooks" \
...
✅ **Command Execution**: AI runs exact `npx swo-agent-toolkit feedback` command  
...
- User must manually run `npx swo-agent-toolkit feedback`
